<?php
	...
	trait InsertOnDuplicateKey
	{
		...
		public static function insertOnDuplicateKey(array $data, array $updateColumns = null) {
			...
			$data = static::inLineFieldsDataArray($data);
		...
		/**
		 * Inline a multiple dimensions field array applying casts and mutators to field data
		 *
		 * @param $data
		 *
		 * @return array
		 */
		protected static function inLineFieldsDataArray(array $data) {
			return call_user_func_array('array_merge', array_map(function ($rowData) {
				/** @var Model $model */
				$model = new static();
